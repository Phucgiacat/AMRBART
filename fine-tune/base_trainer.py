...
class Trainer:
    ...
    def _remove_unused_columns(self, dataset: "datasets.Dataset", description: Optional[str] = None):
        ...
        if 'input_ids_dfs_NRL' not in self._signature_columns:
            self._signature_columns.extend(['input_ids_dfs_NRL', 'labels'])
        if 'input_ids_dfs_NRL_generated' not in self._signature_columns:
            self._signature_columns.extend(['input_ids_dfs_NRL_generated'])
